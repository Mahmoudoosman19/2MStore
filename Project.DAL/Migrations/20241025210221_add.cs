    ...
    public partial class add : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CouponDetail", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliverTime = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUserCouponDetail",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserCouponDetail", x => new { x.applicationUsersId, x.couponDetailsId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserCouponDetail_AspNetUsers_applicationUsersId",
                        column: x => x.applicationUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserCouponDetail_CouponDetail_couponDetailsId",
                        column: x => x.couponDetailsId,
                        principalTable: "CouponDetail",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserCouponDetail_couponDetailsId",
                table: "ApplicationUserCouponDetail",
                column: "couponDetailsId");
